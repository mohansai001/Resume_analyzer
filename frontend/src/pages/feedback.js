      ...
      if (data.success) {
        ...
        setTimeout(() => {
          if (window.opener) {
            ...
            window.location.href = `feedbackform.html?success=true&candidateEmail=${encodeURIComponent(
              candidateEmail
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input type="text" id="interview-date" value={formData.interviewDate} readOnly />
                </td>
              </tr>
              <tr>
