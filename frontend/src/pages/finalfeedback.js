...
const FinalFeedback = () => {
    ...
    useEffect(() => {
        ...
        const fetchEmails = async () => {
            try {
                setIsLoading(true);
                const response = await fetch("https://resumeanalyzer-ggezh7b8b0b5cwat.canadacentral-01.azurewebsites.net/api/getAllCandidateEmails");
    ...
    const fetchCandidateData = async (selectedEmail) => {
        ...
        try {
            ...
            const candidateResponse = await fetch(`https://resumeanalyzer-ggezh7b8b0b5cwat.canadacentral-01.azurewebsites.net/api/getCandidateData?candidateEmail=${selectedEmail}`);
            ...
            const feedbackResponse = await fetch(`https://resumeanalyzer-ggezh7b8b0b5cwat.canadacentral-01.azurewebsites.net/api/final-prescreening?candidateEmail=${selectedEmail}&candidateId=${candidateData.id}&position=${candidateData.role}`);
